...
import { mainnet, optimism, sepolia, arbitrumSepolia, baseSepolia } from 'viem/chains';
...
export const PIMILICO_BUNDLER_TRANSPORT_URL = `https://api.pimlico.io/v2/sepolia/rpc?apikey=${process.env.NEXT_PUBLIC_PIMLICO_API_KEY}`
